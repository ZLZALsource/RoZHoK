...
sudo_users = {SUDO,1048965768,1048965768,1048965768}   
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."uXxUxu:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevZLZALW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1048965768) then  
var = true  
elseif tonumber(user_id) == tonumber(1048965768) then
var = true 
elseif tonumber(user_id) == tonumber(1048965768) then
var = true  
...
var = true
elseif database:sismember(bot_id..'uXxUxu:MN:TF'..chat_id, user_id) then
var = true  
...
local UserName = (data.username_ or "uXxUxu")
...
local ZLZAL_Msg = ''  
if msgs < 100 then 
ZLZAL_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ZLZAL_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ZLZAL_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ZLZAL_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ZLZAL_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ZLZAL_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ZLZAL_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ZLZAL_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ZLZAL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ZLZAL_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ZLZAL_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ZLZAL_Msg = 'امبراطور التفاعل' 
elseif msgs < 10000000000 then 
ZLZAL_Msg = 'رب التفاعل'  
end 
return ZLZAL_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@uXxUxu")  
...
--------------------------------------------------------------------------------------------------------------
function SourceZLZAL(msg,data) -- بداية العمل
if msg then
...
{'ضع اسم للبوت 𖤐','المطورين 𖤐','قائمه العام 𖤐'},
{'المشتركين 𖤐','الكروبات 𖤐'},
{'ضع كليشه ستارت 𖤐','حذف كليشه ستارت 𖤐'},
{'اذاعه 𖤐','اذاعه خاص 𖤐'},
{'اذاعه بالتثبيت 𖤐','قائمه الكتم العام 𖤐'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك 𖤐','تغير الاشتراك'},
{'اذاعه بالتوجيه 𖤐','اذاعه بالتوجيه خاص 𖤐'},
{'تفعيل الاشتراك الاجباري 𖤐','تعطيل الاشتراك الاجباري 𖤐'},
{'الاشتراك الاجباري 𖤐','وضع قناة الاشتراك 𖤐'},
{'تفعيل البوت الخدمي 𖤐','تعطيل البوت الخدمي 𖤐'},
{'تنظيف الكروبات 𖤐','تنظيف المشتركين 𖤐'},
{'جلب نسخه الاحتياطيه 𖤐'},
{'تحديث السورس 𖤐','الاصدار 𖤐'},
{'معلومات السيرفر 𖤐'},
{'الغاء 𖤐'},
}
...
if not DevZLZALW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevZLZALW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,ZLZAL_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل 𖤐' and DevZLZALW(msg) then  
...
if text == 'تعطيل التواصل 𖤐' and DevZLZALW(msg) then  
...
if text == 'تفعيل البوت الخدمي 𖤐' and DevZLZALW(msg) then  
...
if text == 'تعطيل البوت الخدمي 𖤐' and DevZLZALW(msg) then  
...
if text == 'ضع كليشه ستارت 𖤐' and DevZLZALW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖤐 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت 𖤐' and DevZLZALW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر 𖤐' and DevZLZALW(msg) then 
...
if text == 'تحديث السورس 𖤐' and DevZLZALW(msg) then 
os.execute('rm -rf ZLZAL.lua')
os.execute('wget https://raw.githubusercontent.com/ZLZALTEAM/ZLZAL/main/ZLZAL.lua')
send(msg.chat_id_, msg.id_,' 𖤐 تم تحديث السورس \n 𖤐 لديك اخر اصدار لسورس زلزال\n 𖤐 الاصدار » { 2.0v}')
dofile('ZLZAL.lua')  
end
if text == 'الاصدار 𖤐' and DevZLZALW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤐 اصدار سورس زلزال \n 𖤐 الاصدار »{ 2.0v}')
end
...
if text == 'الاحصائيات 𖤐' and DevZLZALW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' الاحصائيات 𖤐 \n'..' 𖤐 عدد الكروبات » {'..Groups..'}'..'\n 𖤐  عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
if text == 'المشتركين 𖤐' and DevZLZALW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖤐 المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات 𖤐' and DevZLZALW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 𖤐 الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 𖤐") and DevZLZALW(msg) then
...
if text == ("قائمه العام 𖤐") and DevZLZALW(msg) then
...
if text == ("قائمه الكتم العام 𖤐") and DevZLZALW(msg) then
...
if text=="اذاعه خاص 𖤐" and msg.reply_to_message_id_ == 0 and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل الان اذاعتك؟ \n 𖤐 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه 𖤐" and msg.reply_to_message_id_ == 0 and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل الان اذاعتك؟ \n 𖤐 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 𖤐" and msg.reply_to_message_id_ == 0 and DevZLZALW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل الان اذاعتك؟ \n 𖤐 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 𖤐" and msg.reply_to_message_id_ == 0  and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص 𖤐" and msg.reply_to_message_id_ == 0  and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 𖤐 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 𖤐' and DevZLZALW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين 𖤐" and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات 𖤐" and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'𖤐  عدد الكروبات الان » { '..#group..' }'..ZLZALk..''..ZLZAL..'\n𖤐  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevZLZALW(msg) then
...
usertext = '\n 𖤐 العضو » ['..result.title_..'](t.me/'..(username or 'uXxUxu')..')'
status  = '\n 𖤐 تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevZLZALW(msg) then
...
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevZLZALW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevZLZALW(msg) then
...
local ZLZAL1_Msg = database:get(bot_id.."ZLZAL1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ZLZAL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤐 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'uXxUxu')..') \n 𖤐 '..ZLZAL1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤐 تم تغيير صورة الكروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' 𖤐 تم تغيير وصف الكروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐 تم حفظ ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------
if ZLZAL_Msg and not Special(msg) then  
local ZLZAL_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ZLZAL_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𖤐 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖤐 ["..ZLZAL_Msg.."] \n")
else
send(msg.chat_id_,0," 𖤐 العضو : {["..data.first_name_.."](T.ME/uXxUxu)}\n 𖤐 ["..ZLZAL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤐 عذرا » {["..data.first_name_.."](T.ME/uXxUxu)}\n 𖤐 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevZLZALW(msg) then
send(msg.chat_id_, msg.id_,' 𖤐 عدد اعضاء الكروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤐 بالتأكيد تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n 𖤐 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤐 تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n 𖤐 بواسطة {'..Name..'}'..
'\n 𖤐 ايدي الكروب {'..IdChat..'}'..
'\n 𖤐 اسم الكروب {['..NameChat..']}'..
'\n 𖤐 عدد اعضاء الكروب *{'..NumMember..'}*'..
'\n 𖤐 الرابط {['..LinkGp..']}'
if not DevZLZALW(msg) then
sendText(SUDO,Text,0,'md')
end
end
end,nil) 
...
send(msg.chat_id_, msg.id_,' 𖤐 بالتأكيد تم تعطيل الكروب')
else
sendText(msg.chat_id_,'\n 𖤐 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤐 تم تعطيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤐 تم تفعيل الكروب')
else
sendText(msg.chat_id_,'\n 𖤐 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤐 تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevZLZALW(msg) then
...
send(msg.chat_id_, msg.id_,' 𖤐 تم تعيين عدد الاعضاء سيتم تفعيل الكروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تغير الاشتراك$") and DevZLZALW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤐 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevZLZALW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤐 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك 𖤐" and DevZLZALW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖤐 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖤐$") and DevZLZALW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤐 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري 𖤐" and DevZLZALW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري 𖤐" and DevZLZALW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖤐 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 𖤐" and DevZLZALW(msg) then  
...
database:sadd(bot_id.."ZLZAL:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ZLZAL:blocname"..msg.chat_id_)
...
function uXxUxu_name(t1,t2)
if t2.id_ then 
name_ZLZAL = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ZLZAL then 
names_ZLZAL = database:smembers(bot_id.."ZLZAL:blocname"..msg.chat_id_) or ""
if names_ZLZAL and names_ZLZAL[1] then 
for i=1,#names_ZLZAL do 
if name_ZLZAL:match("(.*)("..names_ZLZAL[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, uXxUxu_name)
end
...
database:set(bot_id.."ZLZAL:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ZLZAL:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ZLZAL:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ZLZAL:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ZLZAL:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ZLZALa_new(ZLZAL1,ZLZAL2)
if ZLZAL2 and ZLZAL2.first_name_ then 
if ZLZAL2.first_name_:match("(.*)"..database:get(bot_id.."ZLZAL:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZLZAL:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ZLZAL_nnn = database:get(bot_id.."ZLZAL:nump"..msg.chat_id_) or 5
local ZLZAL_nnn2 = database:get(bot_id.."ZLZAL:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ZLZAL_nnn2) == tonumber(ZLZAL_nnn) or tonumber(ZLZAL_nnn2) > tonumber(ZLZAL_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ZLZAL:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "𖤐 عزيزي >>["..ZLZAL2.username_.."](https://t.me/"..(ZLZAL2.username_ or "uXxUxu")..")\n𖤐 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZLZAL:teh"..msg.chat_id_).."} بجانب اسمك\n𖤐 عدد المحاولات المتبقيه {"..(tonumber(ZLZAL_nnn) - tonumber(ZLZAL_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ZLZALa_new)
end
end
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:Sre:stats") == "✔" then
send(msg.chat_id_, msg.id_, '𖤐 تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖤐 تم تعطيل تنبيه الاسماء')
...
local ZLZALChengName = database:get(bot_id.."ZLZAL:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ZLZALChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ZLZALChengName..']')
database:del(bot_id.."ZLZAL:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ZLZALChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ZLZAL:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, '𖤐 تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '𖤐 تم تعطيل تنبيه المعرف')
...
if data.id_ then 
if data.id_ ~= bot_id then
local ZLZALChengUserName = database:get(bot_id.."ZLZAL:Cheng:UserName"..data.id_)
if not data.username_ then 
if ZLZALChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ZLZALChengUserName..']')
database:del(bot_id.."ZLZAL:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ZLZALChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ZLZAL:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, '𖤐 تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '𖤐 تم تعطيل تنبيه الصور')
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ZLZALChengPhoto = database:get(bot_id.."ZLZAL:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ZLZALChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ZLZAL:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ZLZALChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ZLZAL:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevZLZALW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جلب نسخه الاحتياطيه' and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖤐 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'uXxUxu')..') \n 𖤐 تـم قفـل الدردشه ')
end,nil)   
...
if database:get(bot_id..'Cick:kbaa'..msg.chat_id_) then
Text = ' 𖤐 تم تفعيل نسبه الغباء'
database:del(bot_id..'Cick:kbaa'..msg.chat_id_)  
else
Text = ' 𖤐 بالتاكيد تم تفعيل نسبه الغباء'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل نسبه الغباء' and Manager(msg) then  
if not database:get(bot_id..'Cick:kbaa'..msg.chat_id_) then
database:set(bot_id..'Cick:kbaa'..msg.chat_id_,true)  
Text = '\n 𖤐 تم تعطيل نسبه الغباء'
else
Text = '\n 𖤐 بالتاكيد تم تعطيل نسبه الغباء'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = ' 𖤐 بالتاكيد تم تفعيل نسبه الكره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤐 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'uXxUxu')..') \n 𖤐 تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevZLZALW(msg) then    
dofile('ZLZAL.lua')  
send(msg.chat_id_, msg.id_, ' 𖤐 تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevZLZALW(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n 𖤐 تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevZLZALW(msg) then
local list = database:smembers(bot_id..'GBan:User')
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevZLZALW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevZLZALW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevZLZALW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevZLZALW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevZLZALW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevZLZALW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevZLZALW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if text and text:match("^الغاء العام @(.*)$") and DevZLZALW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevZLZALW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevZLZALW(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n 𖤐 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevZLZALW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
...
if database:get(bot_id.."uXxUxu:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'uXxUxu:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."uXxUxu:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'uXxUxu:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevZLZALW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevZLZALW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "uXxUxu")
send(msg.chat_id_, msg.id_," 𖤐 منشئ الكروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
function Function_ZLZAL(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ZLZAL, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ZLZAL, nil)
return false 
end
...
send(msg.chat_id_, msg.id_, "\n𖤐 تم مسح قائمة المطورين الثانويين  ")
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤐 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤐 العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖤐 قائمة مطايه الكروب \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖤐 تم رفع العضو مطي في الكروب \n 𖤐 تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم تنزيل العضو مطي في الكروب\n 𖤐 تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
local  statuss  = '\n 𖤐 تم رفع العضــو الحاته في الكروب \n 𖤐 تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم تنزيل العضــو الحاته من الكروب\n 𖤐 مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤐 تم رفع العضــو الحات في الكروب \n 𖤐 تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم تنزيل العضــو الحات من الكروب\n 𖤐 مشيي مو خوش حات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖤐 قائمة صخوله الكروب \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
local  statuss  = '\n 𖤐 تم رفع المتهم صخل بالكروب\n 𖤐 الان اصبح صخل الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم تنزيل جميع جلاب الكروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖤐 قائمة الجلاب الكروب \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
local  statuss  = '\n 𖤐 تم رفع جلب في الكروب\n 𖤐 تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم تنزيل جميع القروده بالكروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖤐 قائمة القروده الكروب \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
local  statuss  = '\n 𖤐 تم رفع حصان في الكروب\n 𖤐 تعال حبي احطلك سرج وركبك فرني فره حلوه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم تنزيل جميع البقرات بالكروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖤐 قائمة البقرات الكروب \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم تنزيل جميع طليان بالكروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 𖤐 قائمة الطليان الكروب \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
local  statuss  = '\n 𖤐 تم رفع الطلي في الكروب\n 𖤐 طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐 تم تنزيل زاحف من الكروب\n 𖤐 هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
local  statuss  = '\n 𖤐 تم رفع جريذي في الكروب\n 𖤐 خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤐  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n 𖤐  الايدي » '..result.sender_user_id_..'\n 𖤐  تم تنزيله ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
' }\n'..' 𖤐  ردود المدير » { '..rdmder..
' }\n'..' 𖤐  ردود المطور » { '..rdsudo..
' }\n'..' 𖤐  الايدي » { '..idgp..
...
send(msg.chat_id_, msg.id_," 𖤐 تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤐 تم تعطيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_,"𖤐 الرابط معطل") 
return false  
end
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local link = database:get(bot_id.."Private:Group:Link"..msg.chat_id_)            
if link then                              
send(msg.chat_id_,msg.id_,'𖤐 𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿.\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n ['..ta.title_..']('..link..')')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
send(msg.chat_id_, msg.id_,' 𖤐 تم ازالة صورة الكروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤐 تم تفعيل ترحيب الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤐 تم تعطيل ترحيب الكروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤐 تم ازالة ترحيب الكروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖤐 ارسل الكلمه لمنعها")  
database:set(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖤐 ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ZLZAL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ZLZAL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖤐 تم منع الكلمه مع التحذير")  
database:del(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ZLZAL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ZLZAL1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ZLZAL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 𖤐 ارسل الكلمه الان")  
database:set(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZLZAL1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ZLZAL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ZLZAL1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ZLZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ZLZAL1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ZLZAL1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 𖤐 قائمة المنع \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do  
local ZLZAL_Msg = database:get(bot_id.."ZLZAL1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ZLZAL_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevZLZALW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 𖤐 تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevZLZALW(msg) then
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖤐 لا توجد بوتات في الكروب")
else
...
local f = ' 𖤐 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖤐 ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
send(msg.chat_id_, msg.id_," 𖤐 تم حفظ قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖤐 تم ازالة قوانين الكروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤐 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'uXxUxu')..')'..'\n 𖤐 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevZLZALW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevZLZALW(msg) then  
...
if text == 'تفعيل التواصل' and DevZLZALW(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n 𖤐 تم تفعيل التواصل' 
else
...
if text == 'تعطيل التواصل' and DevZLZALW(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n 𖤐 تم تعطيل التواصل' 
else
...
if text == 'تفعيل البوت الخدمي' and DevZLZALW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevZLZALW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if not database:get(bot_id..'uXxUxu:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'uXxUxu:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'زلزال').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'زلزال')
local ZLZAL_Msg = {
'ۿۧهلا ؏ـمࢪي .',
...
send(msg.chat_id_, msg.id_,'['..ZLZAL_Msg[math.random(#ZLZAL_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevZLZALW(msg) then 
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤐 ليست لدي صلاحية تغير اسم الكروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖤐 تم تغيير اسم الكروب الى {['..Name..']}')  
end
end,nil) 
end
...
if text == ("مسح ردود المطور") and DevZLZALW(msg) then 
...
send(msg.chat_id_, msg.id_," 𖤐 تم مسح ردود المطور")
end

if text == ("ردود المطور") and DevZLZALW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖤐 قائمة ردود المطور \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_," 𖤐 تم مسح ردود المدير")
end

if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
text = " 𖤐 قائمه ردود المدير \n⍆══•═══𝙕𝙇══•═══⍅\n"
for k,v in pairs(list) do
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'زلزال').." غادر" or text == 'غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'𖤐 تم مغادرة المجموعه') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
if text == 'تفعيل المغادره' and DevZLZALW(msg) then   
...
if text == 'تعطيل المغادره' and DevZLZALW(msg) then  
...
Text = '\n 𖤐 تم تعطيل ردود المدير' 
else
Text = '\n 𖤐 بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤐 تم تفعيل ردود المطور' 
else
Text = '\n 𖤐 بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤐 تم تعطيل ردود المطور' 
else
Text = '\n 𖤐 بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖤐 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ZLZAL')..') '
status  = '\n𖤐 تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
local iduser = result.sender_user_id_
...
local amir = ' 𖤐 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖤐 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖤐 عدد الاعضاء : '..data.member_count_..
'\n\n 𖤐 عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖤐  اسم الكروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' 𖤐 عذرا لا استطيع طرد ادمنية الكروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖤐 تم طردك من الكروب') 
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤐 تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_,' 𖤐 انت منشئ الكروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤐 الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤐 انت دخلت عبر الرابط لتلح') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤐 تم تعطيل امر منو ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 𖤐 تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖤐 بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤐 تم تعطيل امر منو ضافني'
else
Text = '\n 𖤐 بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤐 تم تنزيل الكل من الرتب الاتيه \n 𖤐 المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = ' 𖤐 تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖤐 بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤐 تم تعطيل امر اطردني'
else
Text = '\n 𖤐 بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
local rtpg = rtpa
local amira = {
" 𖤐 اروح فـدوه للـحلوين",
" 𖤐 فديت الصاك محح",
" 𖤐 فـدشـي عمـي",
" 𖤐 دغـيرهـا شبـي هـاذ",
" 𖤐 شهل الگيمر ",
" 𖤐 شهل الصوره تخمبش ",
" 𖤐 فديت الحلو ",
" 𖤐 بـبكن حـلك ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 𖤐 ايديك ~⪼ '..msg.sender_user_id_..'\n 𖤐 معرفك ~⪼ '..username..'\n 𖤐 رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤐 موقعك ~⪼ '..rtpa..'\n 𖤐 تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖤐 رسائلك ~⪼ '..Msguser..'\n 𖤐 نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖤐 السحكات ~⪼ '..edit..'\n 𖤐 نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 𖤐 ايديك ~⪼ '..msg.sender_user_id_..'\n 𖤐 معرفك ~⪼ '..username..'\n 𖤐 رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖤐 موقعك ~⪼ '..rtpa..'\n 𖤐 تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖤐 رسائلك ~⪼ '..Msguser..'\n 𖤐 نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖤐 السحكات ~⪼ '..edit..'\n 𖤐 نقاطك ~⪼ '..NUMPGAME..']\n')
else
...
if Num == 0 then 
Text = ' 𖤐 لم تقم بأضافه احد'
else
Text = ' 𖤐 عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات" and DevZLZALW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'استعاده الاوامر' and DevZLZALW(msg) then
...
if text == 'تغير امر الاوامر' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر م1' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م1')
database:set(bot_id..'help1'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م2' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م2')
database:set(bot_id..'help2'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م3' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م3')
database:set(bot_id..'help3'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م4' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م4')
database:set(bot_id..'help4'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م5' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م5')
database:set(bot_id..'help5'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م6' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م6')
database:set(bot_id..'help6'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م7' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م7')
database:set(bot_id..'help7'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م8' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐  الان يمكنك ارسال الكليشه م8')
database:set(bot_id..'help8'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م9' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م9')
database:set(bot_id..'help9'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر م10' and DevZLZALW(msg) then
send(msg.chat_id_, msg.id_, ' 𖤐 الان يمكنك ارسال الكليشه م10')
...
Text = [[
*𖤐اهلا انتツفي اوامر البوت𖤐*
ٴ⍆══•═══𝙕𝙇══•═══⍅ٴ
*𖤐م1 ◂ اوامر الحمايه*
*𖤐م2 ◂ اوامر تعطيل ~ تفعيل*
*𖤐م3 ◂ اوامر ضع ~ اضف*
*𖤐م4 ◂ اوامر مسح ~ حذف*
*𖤐م5 ◂ اوامر تنزيل+رفع+التغير*
*𖤐م6 ◂ اوامر الكروب*
*𖤐م7 ◂ اوامر التحشيش*
*𖤐م8 ◂ اوامر مطور البوت*
...
Text = [[
𖤐 اوامر الحمايه اتبع مايلي ...
⊱•═══════════•⊰
𖤐 قفل + فتح ← الامر… 
𖤐 ← { بالتقيد ، بالطرد ، بالكتم }
⊱•═══════════•⊰
𖤐 الروابط
𖤐 المعرف
𖤐 التاك
...
𖤐 البوتات
𖤐 صلاحيه
𖤐 قائمه منع المتحركات
𖤐 قائمه منع الصور
𖤐 قائمه منع الملصقات
𖤐 مسح قائمه المنع
𖤐 المحذوفين
⊱•═══════════•⊰
𖤐 حذف + امر ...
...
𖤐 اوامر التغير …
⊱•═══════════•⊰
𖤐 تغير رد المطور + اسم
𖤐 تغير رد المالك + اسم
𖤐 تغير رد منشئ الاساسي + اسم
𖤐 تغير رد المنشئ + اسم
𖤐 تغير رد المدير + اسم
𖤐 تغير رد الادمن + اسم
𖤐 تغير رد المميز + اسم
𖤐 تغير رد العضو + اسم
𖤐 تغير امر الاوامر
...
𖤐 الاوامر … كالتالي
 ⊱•═══════════•⊰
𖤐 استعاده الاوامر
𖤐 تحويل كالاتي~⪼ صور : ملصق : صوت : بصمه
𖤐 صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين : للمالك
𖤐 كشف القيود 
𖤐 تعين الايدي
𖤐 تغير الايدي
𖤐 الحساب + ايدي الحساب
𖤐 تنظيف + العدد
𖤐 تنزيل الكل
𖤐 تنزيل جميع الرتب
𖤐 منع + برد
𖤐~ الصور + متحركه + ملصق ~
𖤐 حظر ~ كتم ~ تقيد ~ طرد
𖤐 المحظورين ~ المكتومين ~ المقيدين
𖤐 الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
𖤐 تقيد ~ كتم + الرقم + ساعه
𖤐 تقيد ~ كتم + الرقم + يوم
𖤐 تقيد ~ كتم + الرقم + دقيقه
𖤐 تثبيت ~ الغاء تثبيت
𖤐 الترحيب
𖤐 الغاء تثبيت الكل 
𖤐 كشف البوتات
𖤐 الصلاحيات
𖤐 كشف ~ برد ← بمعرف ← ايدي
𖤐 تاك للكل
𖤐 وضع لقب + لقب
𖤐 تاك للمشرفين
𖤐 اعدادات المجموعه
...
send(msg.chat_id_, msg.id_,'𖤐 هاذا الامر خاص بمطور\n𖤐 ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
𖤐اوامر المطورين 
 ⊱•═══════════•⊰
𖤐 تفعيل ← تعطيل 
𖤐 المجموعات ← المشتركين ← الاحصائيات
𖤐 رفع ← تنزيل منشئ اساسي
𖤐 مسح الاساسين ← المنشئين الاساسين
𖤐 مسح المنشئين ← المنشئين
𖤐 رفع ⇠ تنزيل مالك
𖤐 مسح قائمه المالك 
𖤐 اسم ~⪼ غادر + غادر
𖤐 اذاعه 
...
if text == 'م9' then
if not Sudo(msg) then
send(msg.chat_id_, msg.id_,'𖤐 هاذا الامر خاص بالمطور الاساسي\n𖤐 ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
𖤐 المطورين
𖤐 رفع ⇠ تنزيل مطور
𖤐 رفع ~⪼ تنزيل مطور ثانوي
𖤐 الثانويين ~⪼ مسح الثانويين
𖤐 تفعيل ~⪼ تعطيل الاضافات
⊱•═══════════•⊰
𖤐 اسم البوت + غادر
𖤐 غادر
𖤐 اسم بوت + الرتبه
...
𖤐 قائمه العام
𖤐 مسح قائمه العام
𖤐 جلب نسخه الاحتياطيه
𖤐 رفع نسخه الاحتياطيه
 ⊱•═══════════•⊰
𖤐 اذاعه خاص
𖤐 اذاعه
𖤐 اذاعه بالتوجيه
𖤐 اذاعه بالتوجيه خاص
𖤐 اذاعه بالتثبيت
⊱•═══════════•⊰
𖤐 جلب نسخه البوت
𖤐 رفع نسخه البوت
𖤐 ضع عدد الاعضاء + العدد
𖤐 ضع كليشه المطور
𖤐 تفعيل/تعطيل الاذاعه
𖤐 تفعيل/تعطيل البوت الخدمي
𖤐 تفعيل/تعطيل التواصل
𖤐 تغير اسم البوت
𖤐 اضف/حذف رد للكل
𖤐 ردود المطور
𖤐 مسح ردود المطور
⊱•═══════════•⊰
𖤐 الاشتراك الاجباري
𖤐 تعطيل الاشتراك الاجباري
𖤐 تفعيل الاشتراك الاجباري
𖤐 حذف رساله الاشتراك
𖤐 تغير رساله الاشتراك
𖤐 تغير الاشتراك
⊱•═══════════•⊰
𖤐 الاحصائيات
𖤐 المشتركين
𖤐 المجموعات 
𖤐 تفعيل/تعطيل المغادره
𖤐 تنظيف المشتركين
𖤐 تنظيف الكروبات
⊱•═══════════•⊰
彡 .[𝙕𝙇𝙕𝘼𝙇 𝙏𝙀𝘼𝙈](t.me/EIEAE)➢
...
send(msg.chat_id_, msg.id_,' 𖤐 اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' 𖤐 الف مبروك لقد فزت \n 𖤐 للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' 𖤐 اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐 الف مبروك لقد فزت \n 𖤐 للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 𖤐 اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐 اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐 اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖤐 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' 𖤐 مبروك فزت ويانه وخمنت الرقم الصحيح\n 𖤐 تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤐 اوبس لقد خسرت في اللعبه \n 𖤐 حظآ اوفر في المره القادمه \n 𖤐 كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' 𖤐 اوبس تخمينك غلط \n 𖤐 ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖤐 اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' 𖤐 ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' 𖤐 سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," 𖤐 عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤐 مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n 𖤐 لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 𖤐 للاسف لقد خسرت \n 𖤐 المحيبس بل ايد رقم { '..GETNUM..' }\n 𖤐 حاول مره اخرى للعثور على المحيبس')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
𖤐 اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 𖤐 الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' 𖤐اسرع واحد يدز الاختلاف » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
ZLZAL = {'22','30','33','60','90','2','5','36','16','88','50','10','19',};
name = ZLZAL[math.random(#ZLZAL)]
...
send(msg.chat_id_, msg.id_,' 𖤐 حل المسأله الرياضيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
ZLZAL = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','فلوس','اعلم','ذئب','تمساح','ذكي',};
name = ZLZAL[math.random(#ZLZAL)]
...
send(msg.chat_id_, msg.id_,' 𖤐 ترجم الكلمات الاتيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤐 اسرع واحد يكمل المثل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
Text_Games = [[
 𖤐 اوامر الالعاب كتالي 
•━━━━━━━━━━━━━•ٴ
 𖤐 تفعيل الالعاب • لتفعيل العبه ° 
 𖤐 تعطيل الالعاب • لتعطيل العبه °
•━━━━━━━━━━━━━•ٴ
 𖤐 الالعاب الخاصه بسورس 
•━━━━━━━━━━━━━•ٴ
 𖤐 لعبه البات ~⪼ لعبة المحيبس 
 𖤐 لعبه التخمين ~⪼ لعبة البحث
 𖤐 لعبه الاسرع ~⪼ لعبة اسرع شخص
 𖤐 لعبه السمايلات ~⪼ لعبة المطابقه 
 𖤐 لعبه المختلف ~⪼ لعبة الذكاء
 𖤐 لعبه الرياضيات ~⪼ لعبة الارقام
 𖤐 لعبه الانكليزي ~⪼ لعبة ترجمه
 𖤐 لعبه الامثله ~⪼ لعبة تصحيح 
 𖤐 لعبه العكس ~⪼ لعبة عكس الكلمات
...
send(msg.chat_id_, msg.id_, '𖤐 تم تفعيل الردود')
database:del(bot_id..'lock:add'..msg.chat_id_)
end
if text == 'تعطيل الردود' and Manager(msg) then  
send(msg.chat_id_, msg.id_, '𖤐 تم تعطيل الردود')
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لعد اني شنو؟","ليش دتحسسني اني خراعة خضرة؟" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يمة نتلني الاوتي صوجي لعبت بوايرة اخ اوي رد ليورا 😂🖤","شغني وانت اغنيتي المفضلة ، 💘","يوتيوب كدامك؟ 🤍🦦","ثكيل ثكيل ثكيل 😂🔥","نغني سوا؟💞","نار وشرارة الليلة 🔥 حبيبج اجة بكل حيلة 💪🏻"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ادب سسز يباوع على بنات ??🥺"," مو خوش ولد 😶","زاحف وما احبه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك بهاي" or text == "شنو رئيك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"دور حلوين 🤕😹","جكمه وصخه عوفها ☹️😾","حقيرة ومتكبرة  😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "رزله" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"خليصبرلي 😉","عوفة عمري ميستاهل اتعب نفسي ويا يضل يمسلت وحدة 🤭😂","تم سحل الشخص ودفن كرامته بنجاح 😂✅","كلساع تكلولي رزله وهينه خطية شبع رزايل مني 😂👊🏻","اصيح بيك هسة اصيح؟؟🤬"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == "اقتباسات" or text == "نصائح" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
t =[[
رابط الحذف في جميع مواقع التواصل 𖤐
فكر قبل لا تتسرع وتروح
ٴ⍆══•═══𝙕𝙇══•═══⍅ٴ
 𖤐 رابط حذف  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 𖤐 رابط حذف [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 𖤐 رابط حذف [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 𖤐 رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
send(msg.chat_id_, msg.id_, ' 𖤐 تم تعطيل اوامر التحشيش')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, '  𖤐 تم تفعيل اوامر التحشيش')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'زلزال')
...
sl = 'نسبه الحب بين '..text..' هي : '..sendnum..'%'
...
sendnum = num[math.random(#num)]
sl = 'نسبه الكره بين '..text..' هي : '..sendnum..'%'
send(msg.chat_id_, msg.id_,sl) 
...
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
xl = 'نسبه انوثه '..text..' هي : \n '..sendnuj..'%'
send(msg.chat_id_, msg.id_,xl) 
database:del(bot_id..":"..msg.sender_user_id_..":ano_Bots"..msg.chat_id_)
end
if text == "نسبه الغباء" or text == "نسبه غباء" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not database:get(bot_id..'Cick:kbaa'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":kbaa_Bots"..msg.chat_id_,"sendkbaae")
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه غباءه \n مثال زلزال'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه الغباء" and database:get(bot_id..":"..msg.sender_user_id_..":kbaa_Bots"..msg.chat_id_) == "sendkbaae" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
xl = 'نسبه غباء '..text..' هي : \n '..sendnuj..'%'
send(msg.chat_id_, msg.id_,xl) 
database:del(bot_id..":"..msg.sender_user_id_..":kbaa_Bots"..msg.chat_id_)
end
--------------------------------------------------------------------------------------------------------------
...
ZLZAL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ZLZAL)
...
--------------------------------------------------------------------------------------------------------------
SourceZLZAL(data.message_,data)
...
------------------------------------------------------------------------
local uXxUxu = database:get(bot_id.."ZLZAL1:Add:Filter:Rp2"..text..result.chat_id_)   
if uXxUxu then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𖤐 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖤐 ["..uXxUxu.."] \n") 
...
------------------------------------------------------------------------
if text then
local ZLZAL1_Msg = database:get(bot_id.."ZLZAL1:Add:Filter:Rp2"..text..result.chat_id_)   
if ZLZAL1_Msg then    
send(msg.chat_id_, msg.id_," 𖤐 "..ZLZAL1_Msg)
