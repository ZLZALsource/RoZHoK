...
local bl = ' † اهلا عزيزي آلمـطـور\n † آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n † تسـتطـيع‌‏ آلتحگم باوامر البوت\n † من خلال الكيبورد الخاص بك\n † قناة سورس البوت [اضغط هنا](t.me/EIEAE)'
local keyboard = {
...
if text == 'ضع كليشه ستارت †' and DevZLZALW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' † ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت †' and DevZLZALW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' † تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر †' and DevZLZALW(msg) then 
...
send(msg.chat_id_, msg.id_,' † تم تحديث السورس \n † لديك اخر اصدار لسورس زلزال\n † الاصدار » { 2.0v}')
dofile('ZLZAL.lua')  
end
if text == 'الاصدار †' and DevZLZALW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' † اصدار سورس زلزال \n † الاصدار »{ 2.0v}')
end
if text == 'قناه تحديثات البوت †' and DevZLZALW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' † [تحديثات البوت](t.me/EIEAE) \n † [قناه السورس](t.me/EIEAE)')
end
if text == "ضع اسم للبوت †" and DevZLZALW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," † ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات †' and DevZLZALW(msg) then 
...
if text == 'المشتركين †' and DevZLZALW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n † المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات †' and DevZLZALW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n † الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("قائمه الكتم العام †") and DevZLZALW(msg) then
...
if text=="اذاعه خاص †" and msg.reply_to_message_id_ == 0 and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," † ارسل الان اذاعتك؟ \n † للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه †" and msg.reply_to_message_id_ == 0 and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," † ارسل الان اذاعتك؟ \n † للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت †" and msg.reply_to_message_id_ == 0 and DevZLZALW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," † ارسل الان اذاعتك؟ \n † للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه †" and msg.reply_to_message_id_ == 0  and DevZLZALW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," † ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص †" and msg.reply_to_message_id_ == 0  and DevZLZALW(msg) then 
...
send(msg.chat_id_, msg.id_,'†  عدد الكروبات الان » { '..#group..' }'..ZLZALk..''..ZLZAL..'\n†  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n † العضو » ['..result.title_..'](t.me/'..(username or 'uXxUxu')..')'
status  = '\n † تم ترقيته مطور'
...
usertext = '\n † العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n † تم ترقيته مطور'
...
if ZLZAL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' † العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'uXxUxu')..') \n † '..ZLZAL1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," † العضو : {["..data.first_name_.."](T.ME/uXxUxu)}\n † ["..ZLZAL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " † عذرا » {["..data.first_name_.."](T.ME/uXxUxu)}\n † عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == "حذف رساله الاشتراك †" and DevZLZALW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " † تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك †$") and DevZLZALW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' † حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري †" and DevZLZALW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري †" and DevZLZALW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " † تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري †" and DevZLZALW(msg) then  
...
send(msg.chat_id_, msg.id_, "† عزيزي >>["..ZLZAL2.username_.."](https://t.me/"..(ZLZAL2.username_ or "uXxUxu")..")\n† عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ZLZAL:teh"..msg.chat_id_).."} بجانب اسمك\n† عدد المحاولات المتبقيه {"..(tonumber(ZLZAL_nnn) - tonumber(ZLZAL_nnn2)).."}")
end
end
end
end
...
⍆══•═══𝙕𝙇══•═══⍅
 † ↬𝙕𝙇𝙕𝘼𝙇 𝙏𝙀𝘼𝙈
⍆══•═══𝙕𝙇══•═══⍅
 † ↬[Channel ZLZAL](t.me/EIEAE) 
⍆══•═══𝙕𝙇══•═══⍅
 † ↬[DEVELOPER](t.me/uXxUxu)
⍆══•═══𝙕𝙇══•═══⍅
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' † بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'uXxUxu')..') \n † تـم قفـل الدردشه ')
end,nil)   
...
Text = ' † تم تفعيل نسبه الغباء'
database:del(bot_id..'Cick:kbaa'..msg.chat_id_)  
else
Text = ' † بالتاكيد تم تفعيل نسبه الغباء'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n † تم تعطيل نسبه الغباء'
else
Text = '\n † بالتاكيد تم تعطيل نسبه الغباء'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' † بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'uXxUxu')..') \n † تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n † لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
status  = '\n † تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n † العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n † العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'uXxUxu')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n † العضو » ['..result.title_..'](t.me/'..(text1[3] or 'uXxUxu')..')'..'\n † تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n† العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ZLZAL')..') '
...
-- vardump(data) 
ZLZALdx(msg.chat_id_, msg.id_, ' † ايدي المجموعة » ( '..msg.chat_id_..' )\n † عدد الادمنيه » ( *'..data.administrator_count_..' )*\n † عدد المحظورين » ( *'..data.kicked_count_..' )*\n † عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if ZLZAL1_Msg then    
send(msg.chat_id_, msg.id_," † "..ZLZAL1_Msg)
